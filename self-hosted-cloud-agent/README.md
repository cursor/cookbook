...
For Kubernetes, including EKS, follow the official [Kubernetes deployment guide](https://cursor.com/docs/cloud-agent/self-hosted-guides/kubernetes), which covers the Cursor worker-set controller, `WorkerDeployment` resources, scaling, and rolling updates.
